...
GitHub Actions (cron Mon/Wed/Fri)
  ...
  └─► Twelve Data API (real-time market data)
   └─► NVIDIA NIM / GPT-OSS-20B (generate video script)
...
3. **Script Generation** — NVIDIA NIM (GPT-OSS-20B) writes a 5-6 minute video script with scenes, animation cues, and market data
...
| Secret | Description |
|--------|-------------|
| `NVIDIA_API_KEY` | NVIDIA NIM API key (GPT-OSS-20B) |
